  ...
  return (
    <section id="quienes-somos" className="py-20">
      <div className="flex flex-col md:flex-row justify-end items-start relative mx-auto md:max-w-6xl">
        ...
        <div className="relative z-10 w-[85%] md:w-3/4 bg-secondary rounded-lg px-6 pt-12 pb-32 md:pb-24 md:px-16 md:pr-20 text-center md:text-left shadow-lg mx-auto">
          ...
          <div className="space-y-3 text-foreground/80 text-sm md:text-[15px] leading-relaxed md:max-w-[95%]">
            <p>
              ...
              <strong className="font-bold text-primary">Proyecto Vía</strong>.<br />
              La filosofía del proyecto nació en Buenos Aires, Argentina, en el año 2020. En ese entonces, eran un matrimonio recién casado, apasionado por discipular a las nuevas generaciones y promover la extensión del{" "}
              <strong className="font-bold text-primary">Reino de Dios</strong> más allá de las fronteras locales.
            </p>
            <p>
        ...
        {imageData && (
          <div className="md:hidden absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-[65%] sm:translate-y-[80%] w-[60%] z-20">
